    ...
    <div style={{ width: '100%', maxWidth: SVG_W }}>
      ...
      >
        <defs>
          ...
          <marker id="dcarrow" markerWidth="7" markerHeight="7" refX="4" refY="3.5" orient="auto">
            <path d="M0,0 L7,3.5 L0,7 z" fill="#2a1a3a" />
          </marker>
          <marker id="dcarrow-a" markerWidth="7" markerHeight="7" refX="4" refY="3.5" orient="auto">
            <path d="M0,0 L7,3.5 L0,7 z" fill="#c084fc" />
          </marker>
        </defs>
            ...
            <g key={layer.id} onClick={() => onSelect(layer.id)} style={{ cursor: 'pointer' }}>
              {li > 0 && (
                <line
                  ...
                  x2={centerX} y2={y}
                  stroke={isActive || activeId === CHAIN_LAYERS[li - 1].id ? '#c084fc' : '#2a1a3a'}
                  strokeWidth={isActive ? 2 : 1.4}
                  strokeDasharray={isActive ? 'none' : '4 3'}
                  markerEnd={isActive ? 'url(#dcarrow-a)' : 'url(#dcarrow)'}
